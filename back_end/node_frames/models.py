    ...
    def full_arc(cls):
        with connection.cursor() as cursor:
            ...
            query = "select " + fields_as + " from node_frames_arc a " \
                                            "join node_frames_nodeframe as source_ on a.source_id=source_.id " \
                                            "join node_frames_nodeframe sense_ on a.sense_id=sense_.id " \
                                            "join node_frames_nodeframe sink_ on a.sink_id=sink_.id " \
                                            "where sink_.name='brrrr'"
