...
describe("pluck_base_frame", () => {
    ...
    beforeEach(() => {
        ...
        model = Me.brew({terms: {get_identity: () => null, arcs: [arc_a, arc_b, arc_c, arc_d]}});
    });
    ...
    it("removes any arc of which it is a sense or sink", () => {
        full_frame = ContentFrame.brew({
            terms: {
                arcs: [arc_a, arc_b, arc_c, arc_d],
                model: model,
...
describe("base_pluck_on_click", () => {
    describe("pass a full-frame, a base-frame id and the state-setter", () => {
        ...
        beforeEach(() => {
            full_frame = ContentFrame.brew({
                terms: {
                    model: Me.brew({terms: {get_identity: () => null, arcs: [{target: {}}]}}),
